...
import { MENU_SIDERBAR_BODY, MENU_SIDERBAR_BOOTOM } from "../../presetation/utils/consts/menu";
...
export default function Sidebar() {
  ...
  return (
    <div className={`flex flex-col ${open ? 'w-60' : 'w-20'} bg-neutral-900 text-white p-3 duration-300 relative`}>
...
function Siderbar({ item, open }: SidebarProps) {
